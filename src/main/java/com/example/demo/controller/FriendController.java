...
public class FriendController {
    ...
    @RequestMapping("/") public String showFriends(Model model, Authentication auth){
    ...
    @RequestMapping("/add") public String addFriend(Model model){
        model.addAttribute("friend", new Friend());
        return "/friends/add";
    }
    @RequestMapping("/save") public String saveFriend(@ModelAttribute("friend") Friend friend, Authentication myDetails, MultipartHttpServletRequest request){
    ...
    @RequestMapping("/ranked") public String showRankedFriends(Model model, Authentication auth){
